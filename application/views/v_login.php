...
<head>
    ...
    <style>
        .bg-gradient-primary {
            background: url('assets/img/loginanim.mp4') no-repeat center center fixed;
                        ...
                        <div class="row">
                            <div class="col-lg-6 d-none d-lg-block bg-login">
                                <video width="100%" height="100%" controls autoplay muted loop id="video-bg">
                                    <source src="assets/img/loginanim.mp4" type="video/mp4">
                                </video>
                            </div>
                            <div class="col-lg-6">
                                <div class="p-5">
                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-4">Harap Login sebelum masuk!</h1>
                                    </div>
